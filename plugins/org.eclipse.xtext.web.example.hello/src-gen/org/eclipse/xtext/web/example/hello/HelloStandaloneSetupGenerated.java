...
public class HelloStandaloneSetupGenerated implements ISetup {
	...
	public void register(Injector injector) {
		if (!EPackage.Registry.INSTANCE.containsKey("http://www.eclipse.org/xtext/web/example/hello/Hello")) {
			EPackage.Registry.INSTANCE.put("http://www.eclipse.org/xtext/web/example/hello/Hello", HelloPackage.eINSTANCE);
		}
